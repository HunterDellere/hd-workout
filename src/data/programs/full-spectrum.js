...
export const fullSpectrum = {
  ...
  description:
    ...
    + 'gaps and explicit corrective work. Each muscle group is trained once '
    + 'per week at higher per-session volume; if you can train six days and '
    + 'prefer frequency over per-session volume, see PPL 6-day.',
